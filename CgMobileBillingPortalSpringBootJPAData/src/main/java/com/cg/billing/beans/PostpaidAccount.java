...
public class PostpaidAccount {
	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE,generator="mob_gen")
	@SequenceGenerator(name="mob_gen", sequenceName="mob_seq",allocationSize=1,initialValue=920050081)
	...
	public PostpaidAccount(Customer customerID, Plan planID) {
		super();
		this.plan = planID;
	...
	public PostpaidAccount(int customerID, int planID) {
